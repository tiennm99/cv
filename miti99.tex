...
\aboutme{About Me}{A man who loves software architect and want to create a system which can serve many users. Learn from opensource projects on GitHub and reading tech blog.
\begin{itemize}
...
\CVItem{Oct 2020 - Sep 2021, \textit{Associate Software Engineer}, ZingPlay Games Studio, VNG}{
Worked as game developer in both side. Learn about Java \& Javascript.
}

\CVItem{Oct 2021 - Jun 2023, \textit{Software Engineer}, ZingPlay Games Studio, VNG}{
Focus on game server. Learn about software architecture, database.
}

\CVItem{Jul 2023 - Present, \textit{Senior Software Engineer}, ZingPlay Games Studio, VNG}{
Experience in other frameworks: Spring boot, Vert.x to make some web services for game.
}
...
\CVItem{Frameworks, Libraries}{
  \begin{tabular}{p{0.2\textwidth} p{0.2\textwidth} p{0.2\textwidth}}
    \bluebullet Spring Boot & \bluebullet Vert.x & \bluebullet Netty \\
    \bluebullet Gson & \bluebullet Guice & \bluebullet Guava \\
  \end{tabular}
}
...
\CVItem{Softwares}
{\begin{tabular}{p{0.2\textwidth} p{0.2\textwidth} p{0.2\textwidth}}
\bluebullet Jetbrains IDEs & \bluebullet VS Code & \bluebullet Git\\
\end{tabular}}
...
\CVItem{Personal}{Reading novel \& manga, playing Genshin Impact, TFT}
