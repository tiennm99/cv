...
\aboutme{About Me}{A main who loves Linux and opensource softwares, using ArchLinux and wants to customize it as much as possible.
\begin{itemize}
\item Github: \href{https://github.com/tien99/}{\em github.com/tiennm99}
\item Outlook: \href{mailto:tiennm99@outlook.com}{\em tiennm99@outlook.com}
\item Gmail: \href{mailto:minhtienit99@gmail.com}{\em minhtienit99@gmail.com}
\item Facebook: \href{https://www.facebook.com/tiennm99/}{\em facebook.com/tiennm99}
\end{itemize}
}
...
\CVItem{09/2017 - 2023, \href{https://hcmut.edu.vn/}{\em Ho Chi Minh City University of Technology}}{
...
\CVItem{July 6,2020 - September 24,2020, \textit{VNG Tech Fresher}, Game North Studio, VNG}{
...
\bluebullet Java &  \bluebullet Javascript & \bluebullet Html\\
% \bluebullet LaTeX &&\\
\end{tabular}}

\CVItem{Databases}{
  \begin{tabular}{p{0.2\textwidth} p{0.2\textwidth} p{0.2\textwidth}}
  \bluebullet Couchbase & \bluebullet MySQL&\\
  \end{tabular}
}

\CVItem{Frameworks, Libraries}{
  \begin{tabular}{p{0.2\textwidth} p{0.2\textwidth} p{0.2\textwidth}}
    \bluebullet Spring Boot & \bluebullet Gson & \bluebullet Guava \\
    \bluebullet Guice & \bluebullet Event Bus & \bluebullet Netty \\
  \end{tabular}
}
...
\CVItem{Softwares}
{\begin{tabular}{p{0.2\textwidth} p{0.2\textwidth} p{0.2\textwidth}}
\bluebullet VS Code & \bluebullet Jetbrains IDEs & \bluebullet Git\\
\end{tabular}}
...
\CVItem{2020 - present, {Static websites with Hugo}}{
  \begin{itemize}
  \item My blog on GitHub Pages - \href{https://tiennm99.github.io/}{\em tiennm99.github.io} and my team's website \href{https://bkfc-thptduchoa.netlify.app/}{\em bkfc-thptduchoa.netlify.app} using \href{https://gohugo.io/}{\em Hugo}.
  \end{itemize}
}
...
\CVItem{Professional}{Game server, static web, software architecture}

%------------------------------------------------

\CVItem{Personal}{Reading novel \& manga}
