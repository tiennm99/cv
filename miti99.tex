...
\CVItem{05/2020, {Ecrypt tool for Linux}}{
  \begin{itemize}
  \item A tool allows Linux users encrypt and decrypt their data with a key, using C++ and \href{https://www.cryptopp.com/}{Crypto++}
  \end{itemize}
}
